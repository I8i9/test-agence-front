...
const CreateContratStep2 = ({ setContratData, contratData, next, prev , conducteur , doubleSkip }) => {

  console.log("conducteur dans CreateContratStep2:", conducteur , contratData);

  const form = useForm({
    resolver: zodResolver(formSchema),
    shouldUnregister: true,
    defaultValues: {
      nom_prenom: contratData?.conducteur_nom_prenom || conducteur?.nom_prenom || '',
      date_naissance: contratData?.conducteur_date_naissance || ( conducteur?.date_naissance ? new Date(conducteur?.date_naissance) : undefined) || undefined,
      cin_passport: contratData?.conducteur_cin_passport || conducteur?.cin_passport || '', 
      nationalite: contratData?.conducteur_nationalite ||  conducteur?.nationalite || '' ,
      date_delivrance_cin: contratData?.conducteur_date_delivrance_cin ||  (conducteur?.date_delivrance ? new Date(conducteur?.date_delivrance) : undefined) || undefined,
      permis_conduire: contratData?.conducteur_permis_conduire || conducteur?.permis || '',
      date_delivrance_permis: contratData?.conducteur_date_delivrance_permis || (conducteur?.date_delivrance_permis ? new Date(conducteur?.date_delivrance_permis) : undefined) || undefined,
      adresse: contratData?.conducteur_adresse || conducteur?.adresse || '',
      telephone: contratData?.conducteur_telephone || conducteur?.telephone || '',
    },
  });
   ...
   const watchedCinOrPassport = form.watch("cin_passport");
    ...
    console.log("hhhh dans CreateContratStep2:", form.watch("date_delivrance_cin"));
  ...
  const onSubmit = (data) => {
    ...
    setContratData(prev => ({ 
      ...prev,
      has_conducteur: true,
      conducteur_nom_prenom: data.nom_prenom,
      conducteur_date_naissance: data?.date_naissance,
      conducteur_cin_passport: data?.cin_passport ,
      conducteur_nationalite: !data?.date_delivrance_cin ? data.nationalite || undefined : undefined,
      conducteur_date_delivrance_cin: !data?.nationalite ? data?.date_delivrance_cin || undefined : undefined,
      conducteur_permis_conduire: data.permis_conduire,
      conducteur_date_delivrance_permis: data.date_delivrance_permis,
      conducteur_adresse: data.adresse,
      conducteur_telephone: data.telephone,
    }));
    next();
  };
  ...
  const handleSkipStep = () => {
    setContratData(prev => ({ 
        ...prev,
        has_conducteur: false,
        conducteur_nom_prenom: '',
        conducteur_date_naissance: undefined, 
        conducteur_nationality: '',
        conducteur_cin_passport: '',
        conducteur_date_delivrance_cin: undefined, 
        conducteur_permis_conduire: '',
        conducteur_date_delivrance_permis: undefined, 
        conducteur_adresse: '',
    ...
    doubleSkip();
      ...
      console.log("errors dans formSchema:", form.formState.errors);
                  ...
                  <FormItem>
                    ...
                    </FormControl>
                    {
                      form.formState.errors?.nom_prenom ? (
                        ...
                        <FormDescription>
                          Nom complet du conducteur principal
                        </FormDescription>
                      )
                    }
                  </FormItem>
...
export default CreateContratStep2;
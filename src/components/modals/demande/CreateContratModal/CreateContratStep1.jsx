...
const CreateContratStep1 = ({ setContratData, contratData, next , livraisonNegotiable , livraisonPrice , depot }) => {
  ...
  niveau_carburant_depart : z.enum(["Sans Niveau", "VIDE", "UN_QUART", "DEMI", "TROIS_QUARTS","PLEIN"]).default("Sans Niveau"),
      ...
      z.union([
        z.coerce
          ...
          .refine((val) => {
            ...
            if (livraisonNegotiable === "NEGOTIABLE" || livraisonNegotiable === "FIXED") {
              return val >= 0;
            }
            return true;
  ...
  const form = useForm({
    ...
    defaultValues: {
      numero_contrat: contratData.numero_contrat || '',
      depot_garantie: contratData.depot_garantie || (depot ?? ''),
      livraison: contratData.livraison || (livraisonNegotiable==="FIXED" ? livraisonPrice : ''),
      commentaire_contrat: contratData.commentaire_contrat || '',
      niveau_carburant_depart: contratData.niveau_carburant_depart || "Sans Niveau",
    },
  });
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 px-1">
                        ...
                        <Select value={field.value}
                          ...
                          <SelectTrigger className="w-full">
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="TROIS_QUARTS">Trois quart (3/4)</SelectItem>
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      <div className="relative">
                        <Input
                          disabled={!livraisonNegotiable || livraisonNegotiable === "FREE" || livraisonPrice == null }
                          type="number"
                          step="1"
                          className="pr-13"
                      ...
                      {form.formState.errors?.livraison ? (
                        ...
                        <FormDescription>{
                          livraisonPrice == null ? "Le client n'a pas choisi la livraison comme option" :
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel >
                      Commentaire du contrat (Optionnel)
                    </FormLabel>
                    <FormControl>
                      <Textarea
...
export default CreateContratStep1;
...
const CreateCspStep5 = ({ setContratSpData, ContratSpData, next, prev, totalAmount = 0 }) => {

  
  const [selectedOption, setSelectedOption] = useState(ContratSpData?.option_paiement || "full") 
  ...
  const form = useForm({
    ...
    defaultValues: {
      montant_paye: ContratSpData?.montant_paye || 0,
      mode_paiement: ContratSpData?.mode_paiement || "ESPECE",
      reference_paiement: ContratSpData?.reference_paiement || "",
      paiement_echelonne: ContratSpData?.paiement_echelonne || false,
    },
  })
  ...
  useEffect(() => {
    if (selectedOption === "full") {
      ...
      form.setValue("montant_paye", ContratSpData?.montant_paye || 0)
